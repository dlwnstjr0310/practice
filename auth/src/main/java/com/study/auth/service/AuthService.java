...
import com.study.auth.auth.TokenProvider;
import com.study.auth.domain.entity.Member;
import com.study.auth.domain.entity.MemberRole;
import com.study.auth.exception.login.*;
...
import com.study.auth.repository.MemberRepository;
...
public class AuthService {
	...
	public void logout(HttpServletRequest request, LogoutDTO requestDTO) {
		...
		try {
			...
			throw new DifferentTokenVersionException(requestDTO.accessToken());
		}
